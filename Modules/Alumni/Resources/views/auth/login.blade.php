...
@section('title') Alumni Sign In @endsection
@section('top_nav')
    ...
    <div class="xs:block md:flex w-full">
        ...
        <div class="w-full flex-col justify-center items-center p-12">
            ...
            <div class="mt-12 bg-white p-8 rounded-md shadow-lg">
                <form action="{{ route('alumni.login') }}" method="POST" id="std-login-form">
                    @csrf
                    <div class="flex flex-col space-y-4">
                        ...
                        <input type="text" name="email" placeholder="email@example.com" id="email"
                               class="placeholder-gray-700  @error('email') is-invalid @enderror focus:bg-purple-200 rounded-br-xl focus:outline-none"/>
                        @error('email')
                    ...
                    <div class="flex flex-col space-y-4 mt-5">
                        ...
                        <input type="password" name="password" placeholder="******************" id="password"
                               class="placeholder-gray-700 focus:bg-purple-200 rounded-br-xl focus:outline-none @error('password') is-invalid @enderror"/>
                    ...
                    <div class="flex flex-col space-y-4 mt-5">
                        ...
                        @if (Route::has('alumni.password.request'))
                            <a class="btn btn-link" href="{{ route('alumni.password.request') }}">
