...
@section('main')
    <main class="">
        {{-- sidebar --}}
        <div class="xs:hidden md:flex md:flex-col w-1/6 h-screen top-0 left-0 fixed border-r-2 border-blue-100 bg-white shadow-lg">
            {{-- sidebar user info display --}}
            <div class="mt-4 px-5">
                <section class="flex flex-col justify-center items-center space-y-2 font-mono mb-2">
                    <header class="">
                        <img src="{{ asset(config("app.college_logo_png")) }}" alt="" class="border-4 border-blue-200 rounded-full p-1 h-32 w-32" />
                    </header>
        ...
        <nav class="shadow-xl font-semibold xs:ml-0 md:ml-1/6 xs:top-0 fixed w-full xs:bg-white md:bg-none border-b-2 border-blue-100">
            <div class="flex justify-between items-center py-3 px-5 md:mr-1/6">
                ...
                <div class="flex justify-between items-center space-x-5">
                    <div class="text-blue-700 text-md xs:hidden md:flex md:items-center md:space-x-1">
                        ...
                        <img src="{{ asset(config("app.college_logo_png")) }}" alt="" class="border-2 border-blue-200 rounded-full h-8 w-8" />
                        <span class="">
                            Joshua Faloye
                        </span>
                    </div>
            ...
            {{-- fixed header navigation  --}}
             ...
             <div class="md:mt-20 xs:mt-20">
                 ...
                 @elseif ($menuUrl == 'history')
                     @include('stdparent::home.history')
                 @endif
             </div>  
        </div>
    </main>
