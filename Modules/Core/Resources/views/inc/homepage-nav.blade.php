<nav class="flex justify-between items-center py-2 md:py-2 w-full px-2 md:px-8 bg-blue-80 fixed z-10 transition duration-300" id="navbar">
    ...
    <div class="py-1">
        <div class="flex justify-between items-center space-x-8 px-4 md:px-8 md:py-1 text-white">
            <div class="hidden md:flex text-sm items-center space-x-1">
                <a href="{{ url('/') }}"
                    class="{{ request()->is('/') ? 'border-b-2 py-2 border-white hover:border-blue-700 transition duration-300' : 'hover:text-blue-400 py-3 transition duration-500 ' }} font-semibold px-4">
                    Home
                </a>

                <div class="flex flex-col text-left">
                    <button type="button" class="flex items-center hover:text-blue-400 font-semibold transition duration-500 ease-in-out px-4" data-dropdown-toggle="dropdownAbout">
                        About
                ...
                <a href="#" class="flex items-center  hover:text-blue-400 font-semibold transition duration-500 ease-in-out px-4">
                    Academics
                    <svg class="h-4 w-4 animate-pulse ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
                ...
                <div class="flex flex-col text-left">
                    <button type="button" class="flex items-center hover:text-blue-400 font-semibold transition duration-500 ease-in-out px-4" data-dropdown-toggle="dropdownAdministration">
                        Administration
                        <svg class="h-4 w-4 animate-pulse ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                ...
                <a href="{{ url('admissions') }}"
                    class="{{ request()->is('admissions*') ? 'border-b-2 py-2 border-white hover:border-blue-700 transition duration-300' : ' hover:text-blue-400 py-3 transition duration-500 ' }} font-semibold px-4">
                    Admissions
                </a>

                <div class="flex flex-col text-left">
                    <button type="button" class="flex items-center  hover:text-blue-400 font-semibold transition duration-500 ease-in-out px-4" data-dropdown-toggle="dropdownPortal">
                        Portal
                        <svg class="h-4 w-4 animate-pulse  ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                ...
                <div class="flex flex-col text-left">
                    <button type="button" class="flex items-center  hover:text-blue-400 font-semibold transition duration-500 ease-in-out px-4" aria-expanded="true" aria-haspopup="true" data-dropdown-toggle="dropdownUnit">
                        Units
                        <svg class="h-4 w-4 animate-pulse  ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 py-4">
                            <div class="space-y-8">
                                <div class="py-1">
                                    ...
                                    <span class="py-5 px-2 text-lg text-pink-700   font-bold uppercase">
                                        Services
                                    </span>
                                    <a href="#" class="text-gray-700 block px-4 py-1 text-sm hover:text-pink-700 transition duration-300 ease-linear" tabindex="-1" id="menu-item-0">
                                        Medical centre
        ...
        <div class="flex flex-col space-y-2 text-sm">
            ...
            <div class="flex">
                ...
                <div id="MobiledropdownAbout" class="mt-8 w-1/3 shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                    <div class="block px-6 py-4 space-y-2">
                        <a href="#" class="text-gray-700 block px-4 py-1 text-sm hover:text-blue-400 transition duration-300 ease-linear" tabindex="-1" id="menu-item-0">
                            About Faith in Christ Group Of Schools
                        </a>
                        <a href="#" class="text-gray-700 block px-4 py-1 text-sm hover:text-blue-400 transition duration-300 ease-linear" tabindex="-1" id="menu-item-1">
                            Our Philosophy
                        </a>
                        <a href="#" class="text-gray-700 block px-4 py-1 text-sm hover:text-blue-400 transition duration-300 ease-linear" tabindex="-1" id="menu-item-1">
                            Objectives
