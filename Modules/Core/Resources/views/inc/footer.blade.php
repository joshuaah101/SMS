<footer class="bg-blue-800 xs:px-2 md:px-8 pt-5 space-y-3">
    <div class="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-6 p-3 gap-y-7 gap-x-8 xs:mb-3 border-b border-blue-600 text-blue-300">
        <div class="xs:mx-0 h-72 xs:row-span-2 md:col-span-2 order-last">
            <div class="w-full h-72 rounded border">
    ...
    <div class="flex justify-start p-3 text-blue-300 uppercase items-center">
